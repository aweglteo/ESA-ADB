...
from .metrics import MultiChannelMetric, Metric, DefaultMetrics
...
class TimeEval:
    ...
    def __init__(self,
        ...
        self.ranking_metrics: List[MultiChannelMetric] = ranking_metrics
    ...
    def _record_results(self,
        ...
        self.results = self.results._append(new_row, ignore_index=True)
